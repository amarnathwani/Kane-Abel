...
## Changes made:
## * use space invaders instead of breakout
...
# num_actions is 6 for space invaders
num_actions = 6


def log(running_reward, last_reward, episode, mem_perc, epsilon, frame, tensorboard_log = True):
    """
